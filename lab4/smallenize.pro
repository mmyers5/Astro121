...
;     track_head
; loFreq: float
;     the local oscillator frequency used, set by set_lhp(), given in Hz
;
; OUTPUTS
; -------
; velo: list
...
;-
  ...
  FOR i=0, nFiles-1 DO BEGIN
    ...
    filArr[*,i] = channel_sort(fileTagx, j, nSpectra)
  ENDFOR
  RETURN, filArr
END

FUNCTION channel_sort, fileTag, xx, nSpectra 
;+
; OVERVIEW
; --------
...
;-
  ...
  onFil = fileTag+'_on_'+xx+'.fits'
  ;offFil = fileTag+'_off_'+xx+'.fits'
  FOR k=1, nSpectra DO BEGIN           ; loop through extensions        
    ...
    extArr0[*,k-1] = calib(onSpec.auto0_real, 0) ;
