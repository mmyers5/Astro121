...
FUNCTION hour_angle, ra, dec, jDay, sun=sunobs
;+
; OVERVIEW
; --------
...
; jDay: list
;     the julian day list from the structure provided by startchart1
;
; KEYWORDS
; --------
; sun: byte
...
;-
  ...
  FOR i=0, N_ELEMENTS(jDay)-1 DO BEGIN
     ...
     hAngle = [ [hAngle],[ha] ]   ; append to hour angle array
  ENDFOR
  RETURN, hAngle
END
